...
from airflow.providers.apache.beam.operators.beam import BeamRunPythonPipelineOperator  # ← CORRECT
from airflow.providers.google.cloud.operators.dataflow import DataflowConfiguration  # ← NEW
